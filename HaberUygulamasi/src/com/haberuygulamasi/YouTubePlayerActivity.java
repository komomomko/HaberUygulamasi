...
import com.haberuygulamasi.innerlib.PlaylistId;
import com.haberuygulamasi.innerlib.VideoId;
import com.haberuygulamasi.innerlib.YouTubeId;
import com.haberuygulamasi.innerlib.YouTubeUtility;
...
public class YouTubePlayerActivity extends Activity {
	...
	protected String      mMsgInit       = "Bağlantı Kuruluyor";
	
	public final static String MSG_DETECT = "com.keyes.video.msg.detect";
	protected String      mMsgDetect     = "Bant Genişliği Belirleniyor";

	public final static String MSG_PLAYLIST = "com.keyes.video.msg.playlist";
	protected String      mMsgPlaylist   = "YouTube Playlist'teki Son Video Bulunuyor";

	public final static String MSG_TOKEN = "com.keyes.video.msg.token";
	protected String      mMsgToken      = "YouTube Videosu Alınıyor";
	
	public final static String MSG_LO_BAND = "com.keyes.video.msg.loband";
	protected String      mMsgLowBand    = "Düşük Çözünürlüklü Video Yükleniyor";
	
	public final static String MSG_HI_BAND = "com.keyes.video.msg.hiband";
	protected String      mMsgHiBand     = "Yüksek Çözünürlüklü Video Yükleniyor";
	
	public final static String MSG_ERROR_TITLE = "com.keyes.video.msg.error.title";
	protected String      mMsgErrorTitle = "Bağlantı Hatası";
	
	public final static String MSG_ERROR_MSG = "com.keyes.video.msg.error.msg";
	protected String      mMsgError      = "Video alınırken bir hata oluştu.  Bu hata bağlantınızdan ya da Youtube'dan kaynaklı olabilir.  Lütfen daha sonra tekrar deneyiniz.";
